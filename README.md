...
This folder contains the gprMax input and output files for all GPR simulations presented in the study, including homogeneous and heterogeneous ballast models at 1 GHz and 400 MHz.
---
...
### 4. gprMax simulation models

This folder contains the gprMax input and output files used for the GPR simulations presented in this study.  
The models include both homogeneous and heterogeneous railway ballast configurations simulated with 1 GHz and 400 MHz antennas.

Additional information about gprMax is available at:

- https://github.com/gprmax/gprMax
- https://www.gprmax.com/

Example heterogeneous simulation models are shown below.
