...
Each generated sub-block has the following characteristics:
...
- pickled voxel-grid files
- 2D projection images for each z-level
- 3D coloured voxel visualizations
- a text report with overlap and filled-fraction statistics
...
The assembly is performed in a:

- **7 × 7 × 3** grid layout

resulting in a final domain of:
...
- structured 3D assembly of the full domain
...
- combined voxel domain in HDF5 format
- 2D projection image of the full assembled model
- volumetric summary report
